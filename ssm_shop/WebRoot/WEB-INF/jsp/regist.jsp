					...
					<form id="registerForm" action="${pageContext.request.contextPath }/user/regist.action"  method="post" novalidate="novalidate">
						<table>
							...
							<tr>
					            ...
					            <td class="tdError">
					              <label class="error" id="usernameError">${errors.username }</label>
					            </td>
							</tr>
							<tr>
								<th>
					            ...
					            <td>
					              <label class="error" id="passwordError">${errors.password }</label>
					            </td>
							</tr>
							<tr>
								<th>
					            ...
					            <td>
					              <label class="error" id="rePasswordError">${errors.rePassword }</label>
					            </td>
							</tr>
							<tr>
								<th>
					            ...
					            <td>
					              <label class="error" id="emailError">${errors.email }</label>
					            </td>
							</tr>
									<tr>
										<th>
									...
									<tr>
										...
										<td>
												<input type="text" id="phone" name="phone" class="text" onfocus="WdatePicker();">
										</td>
									</tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="verifyCode" name="captcha" class="text" maxlength="4" autocomplete="off">
 										</span>
 										
									</td>
									<td>
										<label class="error" id="verifyCodeError">${errors.verifyCode }</label>
									</td>
								</tr>
								<tr>
									<th>&nbsp;
									...
									<td>
					            		<img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath }/checkImg.action"  onclick="_hyz()" title="点击更换验证码">
					           		</td>
								</tr>
