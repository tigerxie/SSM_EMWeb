			...
			<img src="${pageContext.request.contextPath}/image/a.jpg" width="260" height="343" alt="热门商品" title="热门商品">
						...
						<ul class="tabContent" style="display: block;">
							<c:forEach items="${pHotList }" var="pHot">
								<li>
									<a href="${pageContext.request.contextPath }/product/findByPid.action?pid=${pHot.pid }">
									<img src="${pageContext.request.contextPath }/${pHot.image }" style="display: block;"></a>
								</li>
							</c:forEach>
						</ul>
...
<!-- 					<div class="newProductAd">
						 ...
						 <ul class="tabContent" style="display: block;">
							...
							<c:forEach items="${pNewList }" var="pNew">
								<li>
									<a  target="_blank" href="${pageContext.request.contextPath }/product/findByPid.action?pid=${pNew.pid }">
									<img src="${pageContext.request.contextPath }/${pNew.image }" style="display: block;"></a>									
								</li>
						 	</c:forEach>
						</ul>
						<ul class="tabContent" style="display: none;">
